...
class HoldRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hold_request" do
    assert_difference('HoldRequest.count') do
      post hold_requests_url, params: { hold_request: { book_id: @hold_request.book_id, day_count: @hold_request.day_count, is_approved: @hold_request.is_approved, student_id: @hold_request.student_id } }
    end
  ...
  test "should update hold_request" do
    patch hold_request_url(@hold_request), params: { hold_request: { book_id: @hold_request.book_id, day_count: @hold_request.day_count, is_approved: @hold_request.is_approved, student_id: @hold_request.student_id } }
