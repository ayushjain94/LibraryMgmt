...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { book_id: @bookmark.book_id, student_id: @bookmark.student_id } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { book_id: @bookmark.book_id, student_id: @bookmark.student_id } }
